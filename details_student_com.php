...
<body>
		...
		<center><h1>STUDENT DETAILS</h1>
			...
			<th><a href="offer_job.php?enroll_no=<?php echo $row_Std['enroll_no']; ?>&jid=<?php echo $row['job_id']; ?>"><input type="button" name="approval" value="OFFER THE JOB"></a></th>
			<a href="reject_student_job.php?id=<?php echo $row['email']; ?>"><input type="button" name="reject" value="REJECT"> </a>
